...
public class GMCCommand implements CommandExecutor {
    ...
    public boolean onCommand(@NotNull CommandSender commandSender, @NotNull Command command, @NotNull String s, @NotNull String @NotNull [] strings) {
        ...
        if (!checkPerms(player, "core.staff.gmc")) return noPerms(player);

        player.setGameMode(GameMode.CREATIVE);
        player.sendMessage(Values.getPrefix() + "Your gamemode has been set to " + Values.getAltPrefix() + "CREATIVE");
